...
function ContentView({ node }) {
  ...
  return (
    <div className="bg-white">
      ...
      {hasItems ? (
        <div className="text-gray-700 flex flex-col gap-12">
          {node.items.map(item => (
...
function StudyMode() {
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex gap-12 flex-row items-start">
        <div 
          className="w-72 min-w-[240px] max-w-[280px] flex-shrink-0 sticky bg-white border-r border-gray-200 pr-6 overflow-y-auto" 
          style={{ 
