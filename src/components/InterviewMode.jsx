              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {INTERVIEW_CATEGORIES.map((cat) => (
                  <button
                    ...
                    className="flex flex-col items-center justify-center p-6 border-2 border-gray-200 rounded-lg hover:border-primary hover:bg-primary/5 transition-all text-center"
                  >
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {DIFFICULTY_LEVELS.map((level) => (
                  ...
                  >
                    <div className="font-medium text-sm text-gray-900 mb-1">{level.name}</div>
    ...
    <div className="w-full">
      <div className="mb-6 sm:mb-8 md:mb-12">
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-lg sm:text-xl font-light text-gray-900">模拟面试</h2>
          <button
            onClick={handleReset}
        ...
        {messages.length === 0 && (
          <button
            ...
            className="mt-4 bg-primary text-white px-6 py-2 rounded-lg text-sm font-medium hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-opacity"
          >
            开始面试
          </button>
        )}
